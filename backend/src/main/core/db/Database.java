...
public abstract class Database implements AutoCloseable {
	...
	public Database(final String name, final String url, final String driver, final String username,
	...
	public abstract void execute(final String sql, final Object[] params);
}
